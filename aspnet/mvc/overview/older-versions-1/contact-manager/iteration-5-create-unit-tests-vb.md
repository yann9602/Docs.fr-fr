...
4. Ajouter une référence à l’assembly Moq à votre projet de Test en sélectionnant l’option de menu **projet, ajouter une référence** pour ouvrir le **ajouter une référence** boîte de dialogue. Sous l’onglet Parcourir, accédez au dossier où vous avez décompressé Moq et sélectionnez l’assembly Moq.dll. Cliquez sur le **OK** bouton (voir Figure 2).


[![Le déblocage Moq](iteration-5-create-unit-tests-vb/_static/image1.jpg)](iteration-5-create-unit-tests-vb/_static/image1.png)

**Figure 01**: Moq déblocage ([cliquez pour afficher l’image en taille réelle](iteration-5-create-unit-tests-vb/_static/image2.png))
...
**Figure 03**: Models\ContactManagerServiceTest.cs ([cliquez pour afficher l’image en taille réelle](iteration-5-create-unit-tests-vb/_static/image6.png))
...
**La liste 1 - Models\ContactManagerServiceTest.vb**
...
**Figure 04**: résultats de Test ([cliquez pour afficher l’image en taille réelle](iteration-5-create-unit-tests-vb/_static/image8.png))


## <a name="creating-unit-tests-for-controllers"></a>Création de Tests unitaires pour les contrôleurs

Application ASP.NET MVC contrôler le flux d’interaction de l’utilisateur. Quand un contrôleur de test, que vous souhaitez vérifier si le contrôleur retourne l’action correcte résultat et afficher les données. Vous pouvez également vérifier si un contrôleur interagit avec les classes de modèle de la manière attendue.
...
[Précédent](iteration-4-make-the-application-loosely-coupled-vb.md)
[Suivant](iteration-6-use-test-driven-development-vb.md)
