...
**Important**: n’oubliez pas de générer votre Application ASP.NET MVC après la modification du fichier Global.asax.
...
**Figure 5**: erreur d’itinéraire manquant de racine ([cliquez pour afficher l’image en taille réelle](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image10.png))
