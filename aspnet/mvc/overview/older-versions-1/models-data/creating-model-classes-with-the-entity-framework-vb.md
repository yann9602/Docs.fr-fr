...
La vue de liste 2 contient un **pour chaque** boucle qui effectue une itération dans chaque enregistrement vidéo et affiche les valeurs des propriétés du titre et le directeur de l’enregistrement vidéo. Notez qu’un lien d’édition et de suppression s’affiche en regard de chaque enregistrement. En outre, un lien Ajouter un film apparaît au bas de la vue (voir la Figure 7).

**Figure 7 – la vue Index**

![clip_image014](creating-model-classes-with-the-entity-framework-vb/_static/image7.jpg)

La vue de l’Index est un *typée vue*. La vue de l’Index a un &lt;% @ Page %&gt; directive qui inclut un attribut Inherits. L’attribut Inherits effectue un cast de la propriété ViewData.Model pour une collection fortement typée générique liste d’objets de film : une liste (de film).
...
**La liste 3 – Controllers\HomeController.vb (ajouter des méthodes)**
...
**La liste 4 – Controllers\HomeController.vb (méthodes de modification)**
...
**La liste 6--\Controllers\HomeController.vb (action de suppression)**
