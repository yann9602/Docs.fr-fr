...
[ASP.NET 2.0 instrumenter des Applications pour la sécurité](https://msdn.microsoft.com/en-us/library/ms998325.aspx)
...
[Effectuer une révision de déploiement de sécurité pour ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998367.aspx)
...
[Utiliser ADAM pour les rôles dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998331.aspx)
...
[Utiliser le Gestionnaire d’autorisations (AzMan) avec ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998336.aspx)
...
[Utiliser l’appartenance dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998347.aspx)
...
[Utiliser le Gestionnaire de rôles dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998314.aspx)
...
[Utiliser l’authentification Windows dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998358.aspx)
...
[Effectuer une révision de Code de sécurité pour le Code managé (activité de la ligne de base)](https://msdn.microsoft.com/en-us/library/ms998364.aspx)
...
[Implémenter une délégation Kerberos pour Windows 2000](https://msdn.microsoft.com/en-us/library/aa302400.aspx)
...
[Utiliser la délégation et emprunt d’identité dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998351.aspx)
...
[Créer un modèle de menace pour une Application Web au moment du Design](https://msdn.microsoft.com/en-us/library/ms978527.aspx)
...
[Protéger l’authentification par formulaire dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998310.aspx)
...
[Utiliser l’authentification par formulaire avec Active Directory dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998360.aspx)
...
[Utiliser l’authentification par formulaire avec Active Directory dans plusieurs domaines dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998345.aspx)

Cet article explique comment utiliser l’authentification par formulaire avec le service d’annuaire Microsoft® Active Directory® à l’aide de ActiveDirectoryMembershipProvider. L’article explique comment configurer le fournisseur et de créer et d’authentifier les utilisateurs...

[Utiliser l’authentification par formulaires avec SQL Server dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998317.aspx)
...
[Créer des objets GenericPrincipal avec l’authentification par formulaire dans ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302399.aspx)
...
[Utiliser l’authentification par formulaire avec Active Directory dans ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302397.aspx)
...
[Utiliser l’authentification par formulaires avec SQL Server dans ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302398.aspx)
...
[Empêcher les scripts inter-sites dans ASP.NET](https://msdn.microsoft.com/en-us/library/ms998274.aspx)
...
[Protéger contre l’Injection SQL dans ASP.NET](https://msdn.microsoft.com/en-us/library/ms998271.aspx)
...
[Utiliser des Expressions régulières pour limiter les entrées dans ASP.NET](https://msdn.microsoft.com/en-us/library/ms998267.aspx)
...
[Utiliser la sécurité d’accès du Code dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998326.aspx)
...
[Créer une autorisation de cryptage personnalisé](https://msdn.microsoft.com/en-us/library/aa302362.aspx)
...
[Utilisez la stratégie de sécurité d’accès au Code pour limiter un Assembly](https://msdn.microsoft.com/en-us/library/aa302361.aspx)
...
[Configuration de SSL sur un serveur Web](https://msdn.microsoft.com/en-us/library/aa302411.aspx)
...
[Configurer des certificats de Client](https://msdn.microsoft.com/en-us/library/aa302412.aspx)
...
[Utilisez IPSec pour le filtrage de Ports et l’authentification](https://msdn.microsoft.com/en-us/library/aa302366.aspx)
...
[Utilisez IPSec pour fournir une Communication sécurisée entre deux serveurs](https://msdn.microsoft.com/en-us/library/aa302413.aspx)
...
[Utiliser SSL pour sécuriser la Communication avec SQL Server](https://msdn.microsoft.com/en-us/library/aa302414.aspx)
...
[Appeler un Service Web à l’aide de certificats de Client à partir de ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302408.aspx)
...
[Appeler un Service Web à l’aide de SSL à partir de ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302409.aspx)
...
[Créer une bibliothèque DPAPI dans .NET Framework 1.1](https://msdn.microsoft.com/en-us/library/aa302402.aspx)
...
[Créer une bibliothèque de cryptage dans .NET Framework 1.1](https://msdn.microsoft.com/en-us/library/aa302405.aspx)
...
[Stocker une chaîne de connexion chiffrée dans le Registre dans ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302406.aspx)
...
[Utilisation de DPAPI (magasin de l’ordinateur) depuis ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302403.aspx)
...
[Utilisation de DPAPI (magasin d’utilisateurs) depuis ASP.NET 1.1 avec les Services d’entreprise](https://msdn.microsoft.com/en-us/library/aa302404.aspx)
...
[Créer un compte de Service pour ASP.NET 2.0 Application](https://msdn.microsoft.com/en-us/library/ms998297.aspx)
...
[Améliorer la sécurité lorsque vous hébergez plusieurs Applications dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/aa480478.aspx)
...
[Utiliser le compte de Service réseau pour accéder aux ressources dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998320.aspx)
...
[Utiliser la Transition de protocole et la délégation contrainte dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998355.aspx)
...
[Créer un compte personnalisé pour exécuter ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302396.aspx)
...
[Configurer la clé d’ordinateur dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998288.aspx)
...
[Chiffrer les Sections de Configuration dans ASP.NET 2.0 à l’aide de DPAPI](https://msdn.microsoft.com/en-us/library/ms998280.aspx)
...
[Chiffrer les Sections de Configuration dans ASP.NET 2.0 à l’aide de RSA](https://msdn.microsoft.com/en-us/library/ms998283.aspx)
...
[Se connecter à SQL Server à l’aide de l’authentification SQL dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998300.aspx)
...
[Se connecter à SQL Server à l’aide de l’authentification Windows dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998292.aspx)
...
[Utiliser SSL pour sécuriser la Communication avec SQL Server 2000](https://msdn.microsoft.com/en-us/library/aa302414.aspx)
...
[Utilisez le contrôle d’intégrité dans ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998306.aspx)
...
[Implémentez la gestion des correctifs](https://msdn.microsoft.com/en-us/library/aa302364.aspx)
