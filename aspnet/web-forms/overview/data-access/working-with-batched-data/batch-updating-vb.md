...
Tout d’abord un appel est fait à `BatchUpdate`. Ensuite, le [ `ClientScript` propriété](https://msdn.microsoft.com/library/system.web.ui.page.clientscript(VS.80).aspx) est utilisée pour injecter du code JavaScript qui affiche un messagebox qui lit les produits ont été mis à jour.
