...
title: "Tri personnalisé paginée des données (VB) | Documents Microsoft"
...
![Essayer différentes valeurs pour la procédure stockée s trois paramètres d’entrée](sorting-custom-paged-data-vb/_static/image1.png)

**Figure 1**: essayer différentes valeurs pour la procédure stockée s trois paramètres d’entrée


[![La procédure stockée s les résultats s’affichent dans la fenêtre Sortie](sorting-custom-paged-data-vb/_static/image3.png)](sorting-custom-paged-data-vb/_static/image2.png)

**Figure 2**: s de la procédure stockée, les résultats s’affichent dans la fenêtre Sortie ([cliquez pour afficher l’image en taille réelle](sorting-custom-paged-data-vb/_static/image4.png))
...
![Utilisez le GetProductsPagedAndSorted procédure stockée](sorting-custom-paged-data-vb/_static/image6.png)
...
![Indiquer que la procédure stockée renvoie des données tabulaires](sorting-custom-paged-data-vb/_static/image7.png)
...
![Une tentative trier les résultats les résultats de fournisseur de l’Exception de Runtime suivante](sorting-custom-paged-data-vb/_static/image12.png)
...
![Modifier la SortExpression s intitulée BoundField CompanyName](sorting-custom-paged-data-vb/_static/image13.png)

**Figure 9**: modifier la SortExpression s intitulée BoundField CompanyName


[![Les résultats peuvent maintenant être triés par fournisseur](sorting-custom-paged-data-vb/_static/image15.png)](sorting-custom-paged-data-vb/_static/image14.png)
