...
---
<a name="common-configuration-differences-between-development-and-production-c"></a>Différences de Configuration commune entre le développement et de Production (c#)
====================
...
[Précédent](deploying-your-site-using-visual-studio-cs.md)
[Suivant](core-differences-between-iis-and-the-asp-net-development-server-cs.md)
