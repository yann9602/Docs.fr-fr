...
- DisabledButtonDesigner.vb - cette classe permet à des fonctionnalités au moment du design. Vous avez besoin de cette classe si vous souhaitez que l’extendeur de contrôle pour fonctionner correctement avec Visual Studio/Visual Web Developer Designer.
...
[![Solution avec un projet de bibliothèque de site Web et de la classe](creating-a-custom-ajax-control-toolkit-control-extender-vb/_static/image8.png)](creating-a-custom-ajax-control-toolkit-control-extender-vb/_static/image7.png)

**Figure 01**: Solution avec le projet de bibliothèque de site Web et de la classe ([cliquez pour afficher l’image en taille réelle](creating-a-custom-ajax-control-toolkit-control-extender-vb/_static/image9.png))
...
Vous pouvez vérifier que vous avez ajouté toutes les références à droite en double-cliquant sur votre projet, en sélectionnant les propriétés et en cliquant sur l’onglet Références (voir Figure 2).
...
**Figure 02**: dossier références avec les références requises ([cliquez pour afficher l’image en taille réelle](creating-a-custom-ajax-control-toolkit-control-extender-vb/_static/image12.png))
...
**La liste 1 - MyCustomExtender.vb**
...
**La liste 4 - DisabledButtonDesigner.vb**
