# <a name="key-vault-configuration-provider-sample-application-aspnet-core-1x"></a>Application d’exemple de fournisseur de Configuration de coffre de clés (ASP.NET Core 1.x)
