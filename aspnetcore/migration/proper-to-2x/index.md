...
* [Visual Studio 2017](https://docs.microsoft.com/visualstudio/install/install-visual-studio) version 15.3 ou version ultérieure avec la charge de travail **ASP.NET et développement web**.
