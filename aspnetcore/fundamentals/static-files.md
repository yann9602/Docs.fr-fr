...
---
# <a name="introduction-to-working-with-static-files-in-aspnet-core"></a>Introduction à l’utilisation des fichiers statiques dans ASP.NET Core
...
* [Introduction à ASP.NET Core](../index.md)
