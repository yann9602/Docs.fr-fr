...
[Afficher ou télécharger l’exemple de code](https://github.com/aspnet/docs/tree/master/aspnetcore/fundamentals/configuration/sample) ([comment télécharger](xref:tutorials/index#how-to-download-a-sample))
