...
Pour plus d’informations, consultez [Introduction à la journalisation](xref:fundamentals/logging).
...
* [Configuration du protocole HTTPS pour le développement dans ASP.NET Core](xref:security/https)
