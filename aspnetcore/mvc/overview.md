...
author: ardalis
description: "ASP.NET Core MVC est une infrastructure riche pour la création d’applications web et d'APIs à l’aide du modèle de conception Model-View-Controller."
